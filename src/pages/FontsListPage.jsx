...
export default function FontsListPage({ onSelectFont, onOpenCart }) {
  ...
  return (
    <div style={{ padding: 28, fontFamily: "system-ui, Arial", color: "#111" }}>
      ...
      <div style={{ marginTop: 12, fontSize: 18, color: "#777" }}>
        Выбери шрифт, чтобы перейти к выбору лицензий
      </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", rowGap: 14, maxWidth: 920 }}>
            {fonts.map((f) => (
              ...
              >
                ...
                {f.desc && (
                  <div style={{ marginTop: 10, color: "#333", fontSize: 16, lineHeight: 1.4 }}>
                    {f.desc}
                  </div>
                )}
              </div>
